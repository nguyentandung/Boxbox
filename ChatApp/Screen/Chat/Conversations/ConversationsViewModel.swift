...
final class ConversationViewModel {
    ...
    func createConversation(idCreator: String, idSecondUser: String) {
        DatabaseManager.sharedInstance.createConversation(idCreator: idCreator, idSecondUser: idSecondUser)
    }
...
//        completion(convs)
        ...
        DatabaseManager.sharedInstance.startListenChangeConversations(with: "dungnt1@gmail.com", completion: { convs in
            completion(convs)
        })
